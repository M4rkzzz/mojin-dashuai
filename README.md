...
**0.1.2-beta.13 已开放内测。** [下载 Windows 安装包](https://launcher-direct.boshan.uk:21708/launcher/0.1.2-beta.13/MojinDashuai-Setup-0.1.2-beta.13-x64.exe) · [使用说明](docs/BETA-0.1.2.md)。干净 Windows 验收按用户决定延后，仍保留未通过记录；本次不认定为完整稳定版交付。
...
beta.10 / beta.11 / beta.12 玩家重新打开启动器即可在登录前自动升级到 beta.13。启动器按文件差异更新；最小化按钮左侧常驻“检查更新”，有新版时变绿。设置页显示当前版本。QQ群 1105114550：[点击加入](https://qm.qq.com/q/Bfat8qcPvO)。
