...
- `ui/public/brand/logo.png`：启动器品牌、登录及首次目录设置。
...
后续用户调整：启动器内三服列表、卡片、详情和设置选择器使用各整合包原图标，来源见 `assets/servers/sources.json`。Minecraft 多人游戏列表继续使用统一黑白图标，2026-09-05 已获准重启三服并验证六条线路图标像素一致。
