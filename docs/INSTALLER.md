...
./tools/build-installer.ps1 -Version 0.1.2-beta.7 -Source artifacts/launcher-0.1.2-beta.7-release -Output artifacts/installer-0.1.2-beta.7 -Compiler $compiler
./tools/check-installer.ps1 -Version 0.1.2-beta.7 -Source artifacts/launcher-0.1.2-beta.7-release -Compiler $compiler
python tools/publish-installer.py artifacts/installer-0.1.2-beta.7
```
