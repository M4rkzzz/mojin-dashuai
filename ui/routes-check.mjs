...
try{
 ...
 console.log('Server selection latency passed: all six routes, pending/unreachable states, signal colors, periodic refresh and unchanged manual route mapping.');
