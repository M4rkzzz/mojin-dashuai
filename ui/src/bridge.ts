...
export const defaultSettings: Settings = { root: '', contentDirectoryConfigured:false, memory: {m3e:8192, dc2:8192, mb:8736}, java: {m3e:'', dc2:'', mb:''}, jvm: {m3e:'',dc2:'',mb:'-XX:+UseZGC'}, width:1280, height:720, fullscreen:false, preferDedicatedGpu:true,windowBehavior:'keep', concurrency:4, limitMiB:0, proxy:'', proxyMode:'direct',skinSource:'account',reducedMotion:false, theme:'dark', selectedRoutes:{m3e:'auto', dc2:'auto', mb:'auto'} };
